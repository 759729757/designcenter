...
<!--      <h2 class="section-title">学习经历</h2>-->
      <div class="container-sm">
        ...
        <table>
          ...
          <tr>
            <td>3</td><td>1998</td><td>1999</td>
            <td>From Analogue to Digital Research and Production <br>从模拟到数字的研究与创作</td>
            <td>政府项目； 法国国家当代艺术 <br>工作室</td><td>政府经费</td>
          </tr>
        </table>
